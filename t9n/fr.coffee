fr =
  error:
    accounts:
    # acccounts-base
      "You've been logged out by the server Please login again": "Vous avez été déconnecté par le serveur. Veuillez vous reconnecter."
    ...
    # acccounts-password
      ...
      "Invalid verifier": "Vérifieur incorrect"
