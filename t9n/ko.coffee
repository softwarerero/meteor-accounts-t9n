ko =
  ...
  info:
    ...
    passwordReset: "비밀번호 리셋"

    error:
      emailRequired: "이메일이 필요합니다."
      minChar: "비밀번호는 최소 7자 이상입니다."
      pwdsDontMatch: "비밀번호가 맞지않습니다"
      pwOneDigit: "비밀번호에 숫자 하나이상이 필요합니다."
      pwOneLetter: "비밀번호에 문자 하나이상이 필요합니다."
      signInRequired: "로그인이 필요한 서비스입니다."
      signupCodeIncorrect: "가입 코드가 맞지않습니다."
      signupCodeRequired: "가입 코드가 필요합니다."
      usernameIsEmail: "아이디와 이메일은 달라야합니다."
      ...
      #"Service " + options.service + " already configured"
        ...
        "You've been logged out by the server. Please log in again.": "서버에 의해 로그아웃되셨습니다 다시 로그인해주세요."
      ...
      #---- accounts-password-client
        "Password is old. Please reset your password.": "오래된 비밀번호 입니다 변경해주세요."


      #---- accounts-password
        "Incorrect password": "잘못된 비밀번호 입니다"
