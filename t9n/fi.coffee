...
#Translators: xet7
  ...
  emailResetLink: "Lähetä salasanan palautuslinkki sähköpostilla"
  ...
  resendVerificationEmailLink_pre: "Varmistussähköposti kadonnut?"
  ...
  error:
    ...
    signupCodeIncorrect: "Rekisteröintikoodi on virheellinen."
    signupCodeRequired: "Rekisteröintikoodi vaaditaan."
    ...
    accounts:
      ...
      "Email doesn't match the criteria.": "Sähköposti ei täytä kriteereitä."
      ...
      "old password format": "vanha salasanamuoto"
      ...
      "Verify email link expired": "Sähköpostin varmistuslinkki on vanhentunut"
      "Verify email link is for unknown address": "Sähköpostin varmistuslinkki on tuntemattomalle osoitteelle"
      ...
      "A new email has been sent to you. If the email doesn't show up in your inbox, be sure to check your spam folder.": "Uusi sähköposti on lähetetty sinulle. Jos sähköposti ei näy saapuneissa, tarkista roskapostikansio."
      ...
      "Error, too many requests. Please slow down. You must wait 1 seconds before trying again.": "Virhe, liian monta pyyntöä. Ole hyvä ja hidasta. Sinun täytyy odottaa 1 sekunti ennen kuin yrität uudelleen."
