de =
  error:
    accounts:
    # acccounts-base
      "You've been logged out by the server Please login again": "Der Server hat Dich ausgeloggt. Bitte melde Dich erneut an."
      "Your session has expired. Please login again.": "Deine Sitzung ist abgelaufen. Bitte melde Dich erneut an."
    ...
    # acccounts-password
      ...
      "Invalid verifier": "Prüfkennzeichen mangelhaft"
