...
nl =
  ...
  and: "en"
  back: "terug"
  changePasswort: "Wachtwoord wijzigen"
  choosePasswort: "Wachtwoord kiezen"
  clickAgree: "Door te registreren accepteer je onze"
  configure: "Configureren"
  createAccount: "Account aanmaken"
  currentPasswort: "Huidige wachtwoord"
  ...
  remove: "verwijderen"
  resetYourPasswort: "Wachtwoord resetten"
  setPasswort: "Wachtwoord instellen"
  sign: "Aanmelden"
  signIn: "Aanmelden"
  signin: "aanmelden"
  signOut: "Afmelden"
  ...
  updateYourPasswort: "Wachtwoord actualiseren"
  ...
  info:
    ...
    PasswortChanged: "Wachtwoord gewijzigd"
    PasswortReset: "Wachtwoord gereset"
  ...
  error:
    ...
    signupCodeIncorrect: "Registratiecode ongeldig."
    signupCodeRequired: "Registratiecode verplicht."
    ...
    accounts:
      ...
      "Passwort is old. Please reset your Passwort.": "Wachtwoord is verlopen. Wachtwoord resetten svp."


      #---- accounts-Passwort
      "Incorrect Passwort": "Onjuist wachtwoord"
...
#>    "old Passwort format":
      "Passwort may not be empty": "Wachtwoord mag niet leeg zijn"
      ...
      "User has no Passwort set": "Geen wachtwoord ingesteld voor gebruiker"
