...
Package.onUse(function(api) {
    ...
    api.use('softwarerero:accounts-locale-es-ES@2.0.0');
    ...
    api.use('softwarerero:accounts-locale-no-NB@2.0.0');
    ...
    api.use('softwarerero:accounts-locale-zh-cn@2.0.0');
    api.use('softwarerero:accounts-locale-zh-tw@2.0.0');
});
